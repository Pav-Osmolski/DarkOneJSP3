function oTopBar() {
	...
	this.draw = function (gr) {
		if (this.visible) {
			...
			if (this.logo) gr.DrawBitmap(this.logo, this.x, this.y, this.h, this.h, 0, 0, this.logo.Width, this.logo.Height);
	...
	this.line1 = "";
	this.line2 = "";
	this.logo = DarkOnePerformance.loadBitmap(fb.ComponentPath + "samples\\images\\foobar2000.png");
	this.setDatas();
}
