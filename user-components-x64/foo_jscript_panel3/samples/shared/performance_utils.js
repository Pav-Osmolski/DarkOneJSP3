...
var DarkOnePerformance = typeof DarkOnePerformance != "undefined"
    ...
    function createProfiler(utilsObject, enabled, name, sampleSize) {
        ...
        try { profiler = utilsObject.CreateProfiler(name || "JSP3 Enhanced Samples"); } catch (e) {}
        ...
        return {
            begin: function () {
                if (!profiler) return;
                // Native profiler methods may report typeof == "unknown".
                try { profiler.Reset(); } catch (e) {}
            },
            end: function (suffix) {
                if (!profiler) return;
                ...
                if (count >= samples) {
                    try {
                        console.log((name || "JSP3 Enhanced Samples") + ": average " +
