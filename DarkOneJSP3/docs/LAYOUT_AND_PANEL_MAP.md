...
- DarkOneJSP3/Layout/Toggle, normally labelled LAYOUT, cycles through
  ...
  (InfoStack priority). The selected layout persists.
- DarkOneJSP3/Visualiser/Toggle, normally labelled SPECTRUM, toggles the
  spectrum panel.
...
- DOJSP3.Queue should use a JScript Panel 3 instance loading the DarkOneJSP3
  Queue Viewer wrapper. This is the recommended editable queue implementation.
- The generic enhanced Queue Viewer sample is standalone and read-only; the
  project wrapper is required to activate the JSplitter enumeration/mutation
  bridge.
