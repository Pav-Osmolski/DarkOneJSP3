...
- Manual construction from LAYOUT_AND_PANEL_MAP.txt is the recommended setup.
  ...
  is never required, patched or generated by project tooling. The FCL contains
  the default scripted-queue `DarkOneJSP3` layout and the alternative
  `DarkOneJSP3 Native Queue` layout.
