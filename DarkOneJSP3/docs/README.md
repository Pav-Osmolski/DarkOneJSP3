...
- [THEME_MANAGER.md](THEME_MANAGER.md) — v1.2.0 setup, JSON format, operations and cross-panel application.
...
- DOJSP3.ThemeManager is the optional seventh InfoStack child for v1.2.0.
...
DarkOneJSP3\
  ...
  themes\                Default.json and user-editable theme files
...
- Optional Theme Manager page with readable JSON load/save, naming, rename,
  delete, protected factory reset and coordinated cross-panel application.
