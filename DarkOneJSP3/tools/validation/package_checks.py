...
def run(ctx: ValidationContext) -> None:
    ...
    for path in all_files:
        ...
        if path.name.casefold() in {
                ...
                'darkonejsp3.bottom-area-ack.txt',
                'darkonejsp3.bottom-area-painted.txt',
                'darkonejsp3.theme-release.txt',
    ...
    if gitignore.exists():
        ...
        for runtime_path in [
                ...
                'js_data/darkonejsp3.bottom-area-ack.txt',
                'js_data/darkonejsp3.bottom-area-painted.txt',
                'js_data/darkonejsp3.theme-release.txt',
                'js_data/darkonejsp3.reset-command.txt',
                'js_data/darkonejsp3.theme-command.json',
                'js_data/darkonejsp3.theme-capture-query.json',
                'js_data/darkonejsp3.theme-capture-response.json',
